(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.jsm = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Zh = exports.Z = exports.Yh = exports.Y = exports.Xh = exports.X = exports.VecUI8Clamped = exports.VecUI8 = exports.VecUI64 = exports.VecUI32 = exports.VecUI16 = exports.VecI8 = exports.VecI64 = exports.VecI32 = exports.VecI16 = exports.VecF64 = exports.VecF32 = exports.VecAny = exports.TypedMatFactory = exports.TypedDiagonalFactory = exports.TriangularView = exports.TriangularMode = exports.TransposeView = exports.SVD = exports.RowView = exports.RowPermutation = exports.PaddedView = exports.MinorView = exports.MatUI8Clamped = exports.MatUI8 = exports.MatUI64 = exports.MatUI32 = exports.MatUI16 = exports.MatI8 = exports.MatI64 = exports.MatI32 = exports.MatI16 = exports.MatF64 = exports.MatF32 = exports.MatAny = exports.Mat = exports.Eigen = exports.DiagonalView = exports.DiagonalUI8Clamped = exports.DiagonalUI8 = exports.DiagonalUI64 = exports.DiagonalUI32 = exports.DiagonalUI16 = exports.DiagonalI8 = exports.DiagonalI64 = exports.DiagonalI32 = exports.DiagonalI16 = exports.DiagonalF64 = exports.DiagonalF32 = exports.DiagonalAny = exports.Diagonal = exports.ColumnView = exports.BlockView = void 0;
exports.abs = abs;
...
exports.axisAngle4 = axisAngle4;
exports.block = block;
exports.cartesianToSpherical = cartesianToSpherical;
exports.centralPerspective = centralPerspective;
exports.col = col;
exports.colreduce = colreduce;
exports.colwise = colwise;
exports.computeEigen = computeEigen;
exports.computePLUD = computePLUD;
exports.computeSVD = computeSVD;
exports.computeUBVD = computeUBVD;
exports.cond = cond;
exports.convert = convert;
exports.copy = copy;
exports.cross = cross;
exports.crossMatrix = crossMatrix;
exports.cwiseDiv = cwiseDiv;
exports.cwiseMax = cwiseMax;
exports.cwiseMin = cwiseMin;
exports.cwiseMult = cwiseMult;
exports.deg2rad = deg2rad;
exports.det = det;
exports.diag = diag;
exports.dot = dot;
exports.f64 = exports.f32 = void 0;
exports.fill = fill;
exports.from = from;
...
exports.hvec = hvec;
exports.i8 = exports.i64 = exports.i32 = exports.i16 = void 0;
exports.id = id;
...
exports.norm1 = norm1;
exports.norm2 = norm2;
exports.norm2Squared = norm2Squared;
exports.normFrobenius = void 0;
...
exports.solve = solve;
exports.solveLowerTriagonal = solveLowerTriagonal;
exports.solvePLU = solvePLU;
exports.solveSVD = solveSVD;
exports.solveUpperTriagonal = solveUpperTriagonal;
exports.spherical = spherical;
exports.sqrSum = sqrSum;
exports.sub = sub;
exports.subvec = subvec;
exports.sum = sum;
exports.swapCol = swapCol;
...
exports.ui8c = exports.ui8 = exports.ui64 = exports.ui32 = exports.ui16 = void 0;
exports.unpackUBV = unpackUBV;
exports.vec = vec;
exports.vecFrom = vecFrom;
 ...
 */
exports.TypedDiagonalFactory = TypedDiagonalFactory;
 ...
 */
exports.DiagonalF32 = DiagonalF32;
 ...
 * @extends AbstractMat
 */
exports.DiagonalUI64 = DiagonalUI64;
class DiagonalView {
  /**
   *
   * @param {*} m
 ...
 * @extends AbstractMat
 */
exports.DiagonalView = DiagonalView;
class BlockView {
 ...
 */
exports.TransposeView = TransposeView;
 ...
 * @extends AbstractMat
 */
exports.TriangularMode = TriangularMode;
class TriangularView {
  ...
  checkIndex(i, j) {
    return this._mode === TriangularMode.UPPER && i <= j || this._mode === TriangularMode.LOWER && i >= j || (this._mode === TriangularMode.STRICTLY_UPPER || this._mode === TriangularMode.UNIT_UPPER) && i < j || (this._mode === TriangularMode.STRICTLY_LOWER || this._mode === TriangularMode.UNIT_LOWER) && i > j;
  }
  at(i, j) {
    switch (this._mode) {
  ...
  solve(b, out) {
    if (this._mode === TriangularMode.UPPER || this._mode === TriangularMode.STRICTLY_UPPER || this._mode === TriangularMode.UNIT_UPPER) {
 ...
 * @extends AbstractMat
 */
exports.TriangularView = TriangularView;
 ...
 * @extends AbstractMat
 */
exports.RowPermutation = RowPermutation;
class MinorView {
  constructor(m, i, j) {
 ...
 */
exports.normFrobenius = normFrobenius;
function norm1(m) {
  ...
  while (n >= low) {
    ...
    if (l === n) {
      ...
      while (m >= l) {
        ...
        if (Math.abs(H.at(m, m - 1)) * (Math.abs(q) + Math.abs(r)) < eps * (Math.abs(p) * (Math.abs(H.at(m - 1, m - 1)) + Math.abs(z) + Math.abs(H.at(m + 1, m + 1))))) {
          break;
        }
        m--;
      }
...
function prettyprint(m) {
  ...
  const ls = colreduce(mstr, x => reduce(x, (acc, v) => Math.max(acc, v.length), 0), TypedMatFactory.new(Int16Array).uninitialized(1, m.cols()));
