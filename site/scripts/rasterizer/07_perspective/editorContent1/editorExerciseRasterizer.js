class RasterizerTutorial extends Rasterizer {
  ...
  write_fragment(pipeline, frag_coord, colors) {
    ...
    // TODO
    // *******************************
    // First check, if the depth test is enabled and if the depth image exists (!== null)
    // If both of these conditions are true, check if the fragment's z coordinate is greater than the value stored in the image at the pixel coordinates. If so, we can return, since the fragment is not visible
