...
class PixelImage {
    ...
    static new(data, w, h, comp) {
        return new PixelImage(data, w, h, comp);
    }
    ...
    static random(w, h, c = 4) {
        ...
        const img = PixelImage.new(data, w, h, c);
        img.forEach((x, y, img) => {
    ...
    static zero(w, h, c = 4, type = Float32Array) {
        ...
        return PixelImage.new(data, w, h, c);
    }

    static zeroF32(w, h, c = 4) {
        return PixelImage.zero(w, h, c, Float32Array);
    }

    static zeroF64(w, h, c = 4) {
        return PixelImage.zero(w, h, c, Float64Array);

    }

    static zeroUI8(w, h, c = 4) {
        return PixelImage.zero(w, h, c, Uint8Array);

    }

    static zeroUI8C(w, h, c = 4) {
        return PixelImage.zero(w, h, c, Uint8ClampedArray);
 ...
 * @param {PixelImage} img The image to be sampled
