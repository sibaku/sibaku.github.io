...
$$ \begin{aligned} d^2 &= (r \sin \alpha-0)^2  + (r \cos \alpha)^2 + (h-0)^2 \\ &= r^2\sin^2\alpha + r^2\cos^2\alpha + h^2 \\ &= r^2(\sin^2\alpha + \cos^2\alpha) + h^2 \\
r^2 + h^2\end{aligned} $$
